...
test('PRODUCT NAME: the site calls the product one thing, and it is the catalog name', () => {
  ...
  // was renamed hours after they were reconciled. It appears on the H1, the
  // cards, the breadcrumb, the buy box, two JSON-LD blocks and the photograph's
  // alt text, and the alt text is the surface that escaped the first time.
  //
  ...
  // because both sides of the comparison would come from the same file. The
